      ...
      <div className="w-full max-w-2xl text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <button
            ...
            className="w-full sm:w-48 px-8 py-4 bg-white text-sky-600 rounded-lg text-xl font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 hover:bg-sky-50"
          >
            Login
          </button>
